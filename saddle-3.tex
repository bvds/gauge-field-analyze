...
\begin{figure}
  ...
  \caption{Polyakov loop correlator vs.\ loop area together with
    ...
    with $L_\mu \left|\mathbf{r}\right|>23$.
...
\eq
using $\ge 300$ Euclidean Lattice Monte Carlo configurations, where
$\left\{\mathbf{r}_1, \mathbf{r}_2, \ldots\right\}$ is the set of
...
between them.  We also see that inclusion of the transverse
...
\begin{figure}
  ...
  \caption{Wilson loop expectation value vs.\ loop size together with
    ...
    $16^3$ lattice, $\beta=28$.  The data is from 30 lattice
...
The fit has $\chi^2=9$ for 13 degrees of freedom,
with the covariance matrix derived from 70 lattice configurations.
...
do a very good job untangling the two.
