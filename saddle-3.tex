...
a link field using the Frobenius norm of the logarithm,
%
\be
...
the saddle-point.  The goal here is not to make a precise
measurement of the string tension and glueball spectra
but to measure a wide set of observables in a more qualitative
fashion for a single lattice configuration.
...
string tension at various length scales and will use Wilson loops
...
$\hat{\mu}$.  That is, we sum over the two closest images of the Polyakokv
