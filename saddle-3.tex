...
\begin{abstract}
  ...
  space-time dimensions for various values of $N$.
...
saddle-points to exist in some approximate sense.  In a numerical
procedure, one might expect that a numerical search for a saddle-point
