...
is somewhat larger then Lucini and Teper's continuum value for $\beta=28$,
$\sigma a^2 = 0.016192(54)$ \cite{lucini_$mathrmsun$_2002,athenodorou_sun_2017}
and is likely due to the small lattice volume.
...
We can relate the distribution in $\lambda_j$-space to
the trace $\Tr\mathcal{O}$.
