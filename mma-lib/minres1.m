...
MINRES1(A,B) solves the system of linear equations A*X=B
...
MINRES1(A,B,M,SHIFT) solves (A - SHIFT*I)X = B, or the corresponding
...
minres1[A_Function, b_, M:(None|_Function|_LinearSolveFunction):None, 
